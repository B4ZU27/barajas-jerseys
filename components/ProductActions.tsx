  ...
  return (
    <div className="space-y-6">
      ...
      <a
        ...
        className="flex items-center justify-center gap-2 w-full bg-black text-white py-4 font-bold uppercase tracking-widest text-sm hover:bg-gray-900 transition-colors"
      >
      ...
      {!selectedSize && (
        <p className="text-xs text-center text-gray-400">Selecciona una talla para incluirla en el mensaje</p>
      )}
    </div>
  )
}
